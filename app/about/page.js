      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800 dark:text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white">Abdullah's Journey as a Coder</h2>
          ...
          <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              ...
              <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  After mastering the basics, Abdullah's thirst for knowledge grew. He began exploring more complex topics such as data structures, algorithms, and web development. Enrolling in online courses and attending coding bootcamps, Abdullah quickly expanded his skill set, taking on freelance projects to apply his knowledge in real-world scenarios.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              ...
              <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                  Today, Abdullah is not only a proficient coder but also a mentor to others. He regularly contributes to the programming community by writing tutorials, giving talks, and helping new coders find their footing in the world of software development. For Harry, coding is more than just a profession—it’s a lifelong journey of learning and sharing knowledge.
                </p>
              </div>
            </div>
          </div>
